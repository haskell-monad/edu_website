...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  <TBODY>
	<TR>
	  ...
	  <TD colspan="2" style="PADDING-RIGHT: 10px; MARGIN-TOP: 0px; line-height:28px; height:28px; text-align:right;">&nbsp;您好:${loginAdmin.name }，欢迎使用中国少儿教育网管理后台 &nbsp;&nbsp;&nbsp;

...
<HTML>
	...
	<BODY style="padding:0;margin:0">
		<form name="myForm" method="post" action="info_ylist.do" id="myForm"
			style="margin: 0px">
			<input type="hidden" name="info.channel" id="channelId" value="${info.channel }"/>
			<input type="hidden" name="info.channel" id="channelnames" value="${channel.name}"/>
			...
			<DIV class="column" style="width:99%">
				...
				<table id="MyDataList" cellspacing="1" cellpadding="1"
					...
					<TR class="tdbg" onMouseOver="this.className='tdbg-dark';"  id="tr<s:property value="id"/>"
						...
						<TD  align="left" id="nper<s:property value="id"/>">
							<s:property value="nper"/>
						</TD>
						<TD  align="left" id="htmlIndexnum<s:property value="id"/>">
							<s:property value="htmlIndexnum"/>
						</TD>
						<TD  align="left" id="shorttitle<s:property value="id"/>">
							<a title="点击打开信息页面" href='<%=basePath %><s:property value="pageurl"/>' target="_blank"><s:property value="shorttitle"/></a>
						</TD>

					...
					<TBODY>
						...
						<TR>
							<TD width="30%" align="left">
								<LABEL id=ctl01_ctl00_label><IMG
											style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px"
											id=ctl01_ctl00_imgHelp tabIndex=-1 title=请输入关键词
											src="../../img/help.gif">
									<NOBR>
										<SPAN id=ctl01_ctl00_lblLabel>关键词：</SPAN>
									</NOBR>
								</LABEL>
							</TD>
							<TD width="70%" align="left">
								<INPUT onblur="this.className='colorblur';" id=name
									class=colorblur onfocus="this.className='colorfocus';" 
									size="45" type=text name=channel.keywords value="${channel.keywords}">
								<SPAN  id=ctl03>多个关键词之间使用逗号分割如：建筑,大太阳,行业</SPAN>
							</TD>
						</TR>
						<TR>
							<TD width="30%" align="left">
							...
							<td width="30%" align="left">
								<label id=ctl02_ctl00_label>
									<img
											...
											src="../../img/help.gif">
									<NOBR>
										<span id=ctl02_ctl00_lblLabel>是否是列表页导航：</span>
									</NOBR>
								</label>
							</td>
							<td align="left">
								<input type="radio" id="isok1" name="channel.isSecNavigation" value="1" <s:if test="channel.isSecNavigation==1">checked="checked"</s:if>/>是
								<input type="radio" id="isok0" name="channel.isSecNavigation" value="0" <s:if test="channel==null || channel.isSecNavigation==null || channel.isSecNavigation==0">checked="checked"</s:if> />否
							</td>
						</tr>
						<TR>
							<TD width="30%" align="left">
				...
				<input type="checkbox" name="channel.htmlsite" value="1"  ${"1" == channel.htmlsite ?" checked ":"" }/>静态化站点首页<br/>
						...
						<TR>
							<TD width="70%" align="left"  colspan="10" id="dsecTd" style="display:none">
    							<textarea cols = "80" name = "channel.description" rows = "10" >${channel.description}</textarea >
    							<!-- 

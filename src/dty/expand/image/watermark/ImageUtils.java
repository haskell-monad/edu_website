...
public final class ImageUtils {
    ...
    public final static void pressImage(String targetImg, String waterImg, int x, int y, float alpha) {
            try {
                ...
                int widthDiff = targetImageWidth - waterImgWidth;
                int heightDiff = targetImageHeight - waterImgHeight;
                if(x < 0){
                    x = widthDiff / 2;
                }else if(x > widthDiff){
                    x = widthDiff;
...
*/
    ...
    public static void main(String[] args) throws IOException {
        pressImage("D:\\201311\\1383794653665.jpg", "D:\\201311\\水印.png", 5000, 5000, 1f);
        //pressText("C://pic//jpg", "旺仔之印", "宋体", Font.BOLD|Font.ITALIC, 20, Color.BLACK, 0, 0, 1f);

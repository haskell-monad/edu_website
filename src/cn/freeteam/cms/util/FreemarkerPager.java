...
public class FreemarkerPager {
	...
	public String getTablePageStr() {
		...
		if(currPage-1>=1){
			sb.append("       <td width=\"50\" height=\"40\" align=\"center\" valign=\"middle\"><a href=\"javascript:location.href='"+url+".shtml'\">首页</a></td>");
			sb.append("       <td width=\"50\" height=\"40\" align=\"center\" valign=\"middle\"><a href=\"javascript:location.href='"+url+((currPage-1)>1?"_"+(currPage-2):"")+".shtml';\">上一页</a></td>");
		}else{
		...
		if(currPage+1<=getTotalPage()){
			sb.append("       <td width=\"50\" height=\"40\" align=\"center\" valign=\"middle\"><a href=\"javascript:location.href='"+url+(((currPage+1))>1?"_"+(currPage):"")+".shtml';\">下一页</a></td>");
			sb.append("       <td width=\"50\" height=\"40\" align=\"center\" valign=\"middle\"><a href=\"javascript:location.href='"+url+(((getTotalPage()))>1?"_"+(getTotalPage()-1):"")+".shtml'\">尾页</a></td>");
		}else{
		...
		sb.append("       <td width=\"30\" height=\"40\" align=\"center\" valign=\"middle\"><a href=\"javascript:"+(getTotalPage()>1?"if(isNaN(document.getElementById('pageNum').value)==false&&document.getElementById('pageNum').value!="+currPage
				...
				+"){location.href='"+url+"'+(parseInt(document.getElementById('pageNum').value)>1?'_'+(parseInt(document.getElementById('pageNum').value)-1):'')+'.shtml';}":"void(0)")+"\">跳转</a></td>");
		sb.append("		</tr>");
		sb.append("	  </table></td>");
		sb.append("	</tr>");
		sb.append("</table>");
...
//	}
	...
	public String getFormPageStr() {
		try {
			...
			if((currPage-2)>1){
				sb.append("<a href=\"javascript:pageForm.page.value=1;pageForm.submit();\" value='1'>1</a>...");
			}
//			if(currPage-1>=1){
//				sb.append("<a href=\"javascript:pageForm.page.value=1;pageForm.submit();\">首页</a>&nbsp;");
//				sb.append("<a href=\"javascript:pageForm.page.value="+(currPage-1)+";pageForm.submit();\">上一页</a>&nbsp;");
...
//			}
			for(int i=1;i<=2;i++){
				if((currPage-3+i) >= 1){
					if(currPage-3+i-1==0){
						sb.append("<a href=\"javascript:pageForm.page.value=1;pageForm.submit();\" value='"+(currPage-3+i)+"'>"+(currPage-3+i)+"</a>");
					}else{
						sb.append("<a href=\"javascript:pageForm.page.value='"+(currPage-3+i)+"';pageForm.submit();\" value='"+(currPage-3+i)+"'>"+(currPage-3+i)+"</a>");
					}
				}
			}
			for(int k=1;k<=2;k++){
				if((currPage+k)<= getTotalPage()){
					sb.append("<a href=\"javascript:pageForm.page.value='"+(currPage+k-1)+"';pageForm.submit();\" value='"+(currPage+k-1)+"'>"+(currPage+k-1)+"</a>");
				}
			}
			if((currPage+2)<=getTotalPage()){
				sb.append("...<a href=\"javascript:pageForm.page.value='"+(getTotalPage())+"';pageForm.submit();\" value='"+(getTotalPage())+"'>"+(getTotalPage())+"</a>");
			}else{
				sb.append("<a href=\"javascript:pageForm.page.value='"+(getTotalPage())+"';pageForm.submit();\" value='"+(getTotalPage())+"'>"+(getTotalPage())+"</a>");
			}
...
//		if(currPage-1>=1){
//			sb.append("<a href=\"javascript:location.href='"+url+".shtml'\">首页</a>&nbsp;");
//			sb.append("<a href=\"javascript:location.href='"+url+((currPage-1)>1?"_"+(currPage-2):"")+".shtml';\">上一页</a>&nbsp;");
//		}else{
//			sb.append("首页&nbsp;");
//			sb.append("上一页&nbsp;");
//		}
//		if(currPage+1<=getTotalPage()){
//			sb.append("<a href=\"javascript:location.href='"+url+(((currPage+1))>1?"_"+(currPage):"")+".shtml';\">下一页</a>&nbsp;");
//			sb.append("<a href=\"javascript:location.href='"+url+(((getTotalPage()))>1?"_"+(getTotalPage()-1):"")+".shtml'\">尾页</a>&nbsp;");
//		}else{
//			sb.append("下一页&nbsp;");
//			sb.append("尾页&nbsp;");
//		}
...
//				+"&&document.getElementById('pageNum').value>=1&&document.getElementById('pageNum').value<="+getTotalPage()
//				+"){location.href='"+url+"'+(parseInt(document.getElementById('pageNum').value)>1?'_'+(parseInt(document.getElementById('pageNum').value)-1):'')+'.shtml';}":"void(0)")+"\">跳转</a>&nbsp;");
//		pageStr=sb.toString();
//		return pageStr;
//	}
	/**
	...
	public String getPageStr() {
		...
		if(currPage>0 && currPage!=1){
			sb.append("<a id=\"prevPage\" class=\"disabled\" href=\"javascript:location.href='"+url+((currPage-1)>1?"_"+(currPage-2):"")+".shtml';\"><</a>");
		}
		if((currPage-2)>1){
			sb.append("<a target=\"_self\" href=\"javascript:location.href='index.shtml';\">1</a><em class=\"dots\">...</em>");
		}
		...
		for(int i=1;i<=2;i++){
			if((currPage-3+i) >= 1){
				if(currPage-3+i-1==0){
					sb.append("<a target=\"_self\" href=\"javascript:location.href='index.shtml';\">"+(currPage-3+i)+"</a> ");
				}else{
					sb.append("<a target=\"_self\" href=\"javascript:location.href='"+url+"_"+(currPage-3+i-1)+".shtml';\">"+(currPage-3+i)+"</a> ");
				}
			}
		}
		...
		for(int k=1;k<=2;k++){
			if((currPage+k)<= getTotalPage()){
				sb.append("<a target=\"_self\" href=\"javascript:location.href='"+url+"_"+(currPage+k-1)+".shtml';\">"+(currPage+k)+"</a> ");
			}
		}
		sb.append("</i>");
			
		if((currPage+2)<getTotalPage()){
			sb.append("<em class=\"dots\">...</em><a target=\"_self\" href=\"javascript:location.href='"+url+"_"+(getTotalPage()-1)+".shtml';\">"+getTotalPage()+"</a> ");
		}
		
		if(getTotalPage()!=0 && currPage!=getTotalPage()){
			sb.append(" <a id=\"nextPage\" target=\"_self\" href=\"javascript:location.href='"+url+(((currPage+1))>1?"_"+(currPage):"")+".shtml';\">></a>");
		}
		sb.append("</div>");
		sb.append("</div>");
		pageStr=sb.toString();

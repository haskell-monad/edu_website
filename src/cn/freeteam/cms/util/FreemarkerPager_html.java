 ...
 * <p>============================================</p>
 */
public class FreemarkerPager_html {
	...
	public String getTablePageStr() {
		...
		sb.append("       <tr>");
		sb.append("       <td width=\"100\" height=\"40\" align=\"center\" valign=\"middle\">��&nbsp;<b>"+getTotalCount()+"</b>&nbsp;��</td>");
		if(currPage-1>=1){
			sb.append("       <td width=\"50\" height=\"40\" align=\"center\" valign=\"middle\"><a href=\"javascript:location.href='"+url+".shtml'\">��ҳ</a></td>");
			sb.append("       <td width=\"50\" height=\"40\" align=\"center\" valign=\"middle\"><a href=\"javascript:location.href='"+url+((currPage-1)>1?"_"+(currPage-2):"")+".shtml';\">��һҳ</a></td>");
		}else{
			sb.append("       <td width=\"50\" height=\"40\" align=\"center\" valign=\"middle\">��ҳ</td>");
			sb.append("       <td width=\"50\" height=\"40\" align=\"center\" valign=\"middle\">��һҳ</td>");
		}
		if(currPage+1<=getTotalPage()){
			sb.append("       <td width=\"50\" height=\"40\" align=\"center\" valign=\"middle\"><a href=\"javascript:location.href='"+url+(((currPage+1))>1?"_"+(currPage):"")+".shtml';\">��һҳ</a></td>");
			sb.append("       <td width=\"50\" height=\"40\" align=\"center\" valign=\"middle\"><a href=\"javascript:location.href='"+url+(((getTotalPage()))>1?"_"+(getTotalPage()-1):"")+".html'\">βҳ</a></td>");
		}else{
			sb.append("       <td width=\"50\" height=\"40\" align=\"center\" valign=\"middle\">��һҳ</td>");
			sb.append("       <td width=\"50\" height=\"40\" align=\"center\" valign=\"middle\">βҳ</td>");
		}
		...
		sb.append("       <td width=\"30\" height=\"40\" align=\"center\" valign=\"middle\"><a href=\"javascript:"+(getTotalPage()>1?"if(isNaN(document.getElementById('pageNum').value)==false&&document.getElementById('pageNum').value!="+currPage
				...
				+"){location.href='"+url+"'+(parseInt(document.getElementById('pageNum').value)>1?'_'+(parseInt(document.getElementById('pageNum').value)-1):'')+'.html';}":"void(0)")+"\">��ת</a></td>");
		sb.append("		</tr>");
		sb.append("	  </table></td>");
		sb.append("	</tr>");
		sb.append("</table>");
	...
	public String getFormTablePageStr() {
		...
		try {
			...
			sb.append("       <td width=\"100\" height=\"40\" align=\"center\" valign=\"middle\">��&nbsp;<b>"+getTotalCount()+"</b>&nbsp;��</td>");
			if(currPage-1>=1){
				sb.append("       <td width=\"50\" height=\"40\" align=\"center\" valign=\"middle\"><a href=\"javascript:pageForm.page.value=1;pageForm.submit();\">��ҳ</a></td>");
				sb.append("       <td width=\"50\" height=\"40\" align=\"center\" valign=\"middle\"><a href=\"javascript:pageForm.page.value="+(currPage-1)+";pageForm.submit();\">��һҳ</a></td>");
			}else{
				sb.append("       <td width=\"50\" height=\"40\" align=\"center\" valign=\"middle\">��ҳ</td>");
				sb.append("       <td width=\"50\" height=\"40\" align=\"center\" valign=\"middle\">��һҳ</td>");
			}
			if(currPage+1<=totalPage){
				sb.append("       <td width=\"50\" height=\"40\" align=\"center\" valign=\"middle\"><a href=\"javascript:pageForm.page.value="+(currPage+1)+";pageForm.submit();\">��һҳ</a></td>");
				sb.append("       <td width=\"50\" height=\"40\" align=\"center\" valign=\"middle\"><a href=\"javascript:pageForm.page.value="+(totalPage)+";pageForm.submit();\">βҳ</a></td>");
			}else{
				sb.append("       <td width=\"50\" height=\"40\" align=\"center\" valign=\"middle\">��һҳ</td>");
				sb.append("       <td width=\"50\" height=\"40\" align=\"center\" valign=\"middle\">βҳ</td>");
			}
			sb.append("		  <td width=\"220\" align=\"center\" valign=\"middle\" >ÿҳ&nbsp;<b>");
			sb.append(pageSize+"</b>&nbsp;");
			...
			sb.append("	  <td width=\"35%\" height=\"40\" align=\"center\" valign=\"middle\"><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\">");
			sb.append("		<tr>");
			sb.append("       <td width=\"120\" height=\"40\" align=\"center\" valign=\"middle\">��&nbsp;<input name=\"pageNum\" type=\"text\" value=\""+currPage+"\" class=\"ts_box4\" size=\"1\" style=\"text-align:center\">&nbsp;ҳ</td>");
			sb.append("       <td width=\"30\" height=\"40\" align=\"center\" valign=\"middle\"><a href=\"javascript:"+(totalPage>1?"if(isNaN(pageForm.pageNum.value)==false&&pageForm.pageNum.value!="+currPage+"&&pageForm.pageNum.value>=1&&pageForm.pageNum.value<="+totalPage+"){pageForm.page.value=pageForm.pageNum.value;pageForm.submit();}":"void(0)")+"\">��ת</a></td>");
			sb.append("		</tr>");
			sb.append("	  </table></td>");
			sb.append("	</tr>");
			sb.append("</table>");
...
//		StringBuffer sb=new StringBuffer();
//		sb.append("共&nbsp;<b>"+getTotalCount()+"</b>&nbsp;条&nbsp;");
//		System.out.println("共"+getTotalCount()+"条");
//		if(currPage-1>=1){
...
//	}
	/**
	 * 列表页分页  update by limengyu at 20131028
	 * @return
	 */
	public String getPageStr() {
		StringBuffer sb=new StringBuffer();
		sb.append("<div class=\"black-box clearfix\">");
		sb.append("<div class=\"black\">");
		if(currPage>0 && currPage!=1){
			sb.append("<a id=\"prevPage\" class=\"disabled\" href=\"javascript:location.href='"+url+((currPage-1)>1?"_"+(currPage-2):"")+".html';\">上一页</a>");
		}
		if((currPage-2)>1){
			sb.append("<a target=\"_self\" href=\"javascript:location.href='index.html';\">1</a>...");
		}
		...
		for(int i=1;i<=2;i++){
			if((currPage-3+i) >= 1){
				if(currPage-3+i-1==0){
					sb.append("<a target=\"_self\" href=\"javascript:location.href='index.html';\">"+(currPage-3+i)+"</a> ");
				}else{
					sb.append("<a target=\"_self\" href=\"javascript:location.href='"+url+"_"+(currPage-3+i-1)+".html';\">"+(currPage-3+i)+"</a> ");
				}
			}
		}
		sb.append("<span class=\"current\">");
		sb.append("<a target=\"_self\">"+currPage+"</a>");
		sb.append("</span>");
		for(int k=1;k<=2;k++){
			if((currPage+k)<= getTotalPage()){
				sb.append("<a target=\"_self\" href=\"javascript:location.href='"+url+"_"+(currPage+k-1)+".html';\">"+(currPage+k)+"</a> ");
			}
		}
		sb.append("</i>");
			
		if((currPage+2)<getTotalPage()){
			sb.append("...<a target=\"_self\" href=\"javascript:location.href='"+url+"_"+(getTotalPage()-1)+".html';\">"+getTotalPage()+"</a> ");
		}
		
		if(getTotalPage()!=0 && currPage!=getTotalPage()){
			sb.append(" <a id=\"nextPage\" target=\"_self\" href=\"javascript:location.href='"+url+(((currPage+1))>1?"_"+(currPage):"")+".html';\">下一页</a>");
		}
		sb.append("</div>");
		sb.append("</div>");
		pageStr=sb.toString();

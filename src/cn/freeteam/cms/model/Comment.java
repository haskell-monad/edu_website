...
public class Comment {
    ...
    private int isRandomAddTime;//0不生成随机时间，1生成随机时间
    private int infoAddTimeHours;
    ...
    /**
     * update by limengyu at 20131023
     * 评论的文章的标题
     */
	...
	public int getIsRandomAddTime() {
		return isRandomAddTime;
	}

	public void setIsRandomAddTime(int isRandomAddTime) {
		this.isRandomAddTime = isRandomAddTime;
	}

	public int getInfoAddTimeHours() {
		return infoAddTimeHours;
	}

	public void setInfoAddTimeHours(int infoAddTimeHours) {
		this.infoAddTimeHours = infoAddTimeHours;
	}

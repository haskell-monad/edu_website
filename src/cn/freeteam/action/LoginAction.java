...
public class LoginAction extends BaseAction{
	...
	public String login(){
		try {
			...
			if (msg==null || "".equals(msg)) {
				 ...
				 * 
				 */
				Cookie cookie1=new Cookie("loginAdmin",user.getLoginname());
				cookie1.setDomain(".jzpt.com");
				Cookie cookie2=new Cookie("loginAdmin",user.getLoginname());
	...
	/**
	 * update by limengyu at @2013.10.31
	 * @return
	 */
	public String newlogin(){
		try {
			...
			if (msg==null || "".equals(msg)) {
				...
				Cookie cookie1=new Cookie("loginAdmin",user.getLoginname());
				cookie1.setDomain(".jzpt.com");
				cookie1.setMaxAge(1000*60*60*24);//有效时间为一年
				Cookie cookie2=new Cookie("loginAdmin",user.getLoginname());
				cookie2.setDomain(".10333.com");
				cookie2.setMaxAge(1000*60*60*24);//有效时间为一年
				getHttpResponse().addCookie(cookie1);
				getHttpResponse().addCookie(cookie2);
				OperLogUtil.log(user.getLoginname(), "登录系统", getHttpRequest());
